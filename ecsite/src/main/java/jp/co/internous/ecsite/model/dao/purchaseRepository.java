...
public interface purchaseRepository extends JpaRepository<Purchase, Long> {
	...
	List<Purchase> findHistoory(@Param("userId") long userId);
	...
	@Transactional
	@Modifying
	void persist(@Param("userId") long userId, @Param("goodsId") long productId, @Param("goodsName") String goodsName,
